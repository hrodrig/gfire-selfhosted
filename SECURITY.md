...
- **Preferred:** Use [GitHub Security Advisories](https://github.com/hrodrig/gfire-selfhosted/security/advisories/new) to report privately.
...
Application vulnerabilities in **gfire** / **gfireui** / **gfireui-backend** should be reported against those repositories.
